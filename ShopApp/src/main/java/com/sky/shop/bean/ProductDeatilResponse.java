...
public class ProductDeatilResponse implements Serializable {
    ...
    private List<String> product_image_urls;//商品详情
    ...
    private String product_type_two;
    ...
    public String getProduct_type_two() {
        return product_type_two;
    }

    public void setProduct_type_two(String product_type_two) {
        this.product_type_two = product_type_two;
    }
