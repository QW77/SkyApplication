...
public class AskSecondPic extends BaseViewActivity<OrderContract.CommentPresenter>
    ...
    AskOne addCommentInfo = new AskOne();
    ...
    public void initViewsAndEvents() {
        ...
        commentGridviewAdapter = new CommentGridviewAdapter(imagePath, AskSecondPic.this);
        ...
        comment_gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == parent.getChildCount() - 1) {
                    if (ContextCompat.checkSelfPermission(AskSecondPic.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                            != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(AskSecondPic.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                Constants.Permission.CAMERA_PERMISSION);
                    } else {
                        AppDialogUtils.showTakePhotoView(AskSecondPic.this);
                    }
                }
            }
        });
...
//        getPresenter().getAskData(cacheUid, id, "0", eval_id, 5, coment,addCommentInfo);
        getPresenter().requestCenterAsk(eval_id, 5, coment, addCommentInfo);
    }
