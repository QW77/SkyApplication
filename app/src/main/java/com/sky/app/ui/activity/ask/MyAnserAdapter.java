...
public class MyAnserAdapter extends BaseAdapter {
    private List<MyAnser.ListBean> acountList;
    private Context context;
    private LayoutInflater mInflater = null;

    public MyAnserAdapter(List<MyAnser.ListBean> acountList, Context context) {
