...
public class BaiduMapActivityMy extends AppCompatActivity implements View.OnClickListener {
    ...
    private BaiduMapActivityMy.MyLocationListener myListener = new BaiduMapActivityMy.MyLocationListener();
            ...
            Snackbar.make(v, "permission_contacts_rationale",
                    ...
                    .setAction("ok", new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat
                                    .requestPermissions(BaiduMapActivityMy.this, PERMISSIONS_CONTACT,
                                            REQUEST_CONTACTS);
                        }
                    })
                    .show();
    ...
    private void routeBikePlanWithParam() {
        ...
        mNaviBikeHelper.routePlanWithParams(paramBike, new IBRoutePlanListener() {
            ...
            public void onRoutePlanSuccess() {
                ...
                intent.setClass(BaiduMapActivityMy.this, BNaviGuideActivity.class);
    ...
    private void routePlanWithParam() {
        mNaviHelper.routePlanWithParams(param, new IWRoutePlanListener() {
            ...
            public void onRoutePlanSuccess() {
                Log.d(TAG, "算路成功,跳转至诱导页面");
                Intent intent = new Intent();
                intent.setClass(BaiduMapActivityMy.this, WNaviGuideActivity.class);
                startActivity(intent);
            }
