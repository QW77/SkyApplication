...
public class SecondCategoryTwoGridviewAdapter extends BaseAdapter {
    ...
    public SecondCategoryTwoGridviewAdapter(List<Category> acountList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            //根据自定义的Item布局加载布局
            convertView = mInflater.inflate(R.layout.item_twocategory, null);
            holder.category_img = (ImageView) convertView.findViewById(R.id.category_img_2);
            holder.category_name1 = (TextView)convertView.findViewById(R.id.category_name1_2);
