...
public class CategoryMenuDialog extends Dialog{
    ...
    private ProductCategoryAdaptor productCategoryAdaptor, productCategory2Adaptor;
    ...
    private void initView() {
        ...
        productCategoryAdaptor = new ProductCategoryAdaptor(mContext, categories, 1);
        productCategoryAdaptor.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int pos) {
                ...
                if (null == productCategory2Adaptor){
                    productCategory2Adaptor = new ProductCategoryAdaptor(mContext, categories2, 2);
    ...
    public void windowDeploy() {
        ...
        windowAttributes.y = AppUtils.dip2px(mContext, 56); // y小于0上移，大于0下移
